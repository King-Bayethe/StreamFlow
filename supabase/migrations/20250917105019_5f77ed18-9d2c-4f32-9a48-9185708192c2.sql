...
-- Additional streams to populate the platform
((SELECT user_id FROM profiles WHERE username = 'LordMalachai'), 'Souls Series Marathon - Demon Souls Preparation', 'Getting ready for the ultimate challenge with classic Demon Souls', 'offline', 0, 13450, NOW() - INTERVAL '2 weeks', NOW() - INTERVAL '1 week 6 days 21 hours', 22340, 'https://images.unsplash.com/photo-1511512578047-dfb367046420?w=400&h=300&fit=crop', false),

((SELECT user_id FROM profiles WHERE username = 'Luxor6666'), 'Platformer Paradise - A Hat in Time 100%', 'Collecting every achievement in this adorable 3D platformer', 'offline', 0, 6780, NOW() - INTERVAL '2 weeks 2 days', NOW() - INTERVAL '2 weeks 22 hours', 11890, 'https://images.unsplash.com/photo-1578662996442-48f60103fc96?w=400&h=300&fit=crop', false);